...
public class SVNVersionControl {
    ...
    public SVNVersionControl(String url, String name, String password) {
        /*
         * default values:
         */
        //String url = "http://svn/psg/RMB_SVN/branches/Portfolio/8.7.1.29";
        //String name = "psgdevopsuser";
        //String password = "Gsource@123";
     ...
     *  
     */
    public List<String> getCompleteFileList(SVNRepository repository, String path)
            throws SVNException {
        /*
        ...
        while (iterator.hasNext()) {
            ...
            if (entry.getKind() == SVNNodeKind.DIR) {
                fileList.addAll(getCompleteFileList(repository, (path.equals("")) ? entry.getName()
                        : path + "/" + entry.getName()));
            }
        }
        return fileList;
    ...
    public List<String> getChangedFileList(SVNRepository repository)
            throws SVNException {

        List changedFileList = new ArrayList<String>();
        ...
        for (Iterator entries = logEntries.iterator(); entries.hasNext();) {
            ...
            if (logEntry.getChangedPaths().size() > 0) {
                ...
                for (Iterator changedPaths = changedPathsSet.iterator(); changedPaths.hasNext();) {
                    ...
                    SVNNodeKind snk = entryPath.getKind();
                    System.out.println("Type: "+snk+"  Action: " +entryPath.getType()+ " "+ entryPath.getPath()+ ((entryPath.getCopyPath() != null) ? " (from "+ entryPath.getCopyPath() + " revision "+ entryPath.getCopyRevision() + ")" : ""));

                    if ((entryPath.getType() == 'A' || entryPath.getType() == 'M') && snk.toString().equals("file")) {
                        System.out.println(entryPath.getPath());
                        changedFileList.add(entryPath.getPath());
                    }
                }
            }
        }
